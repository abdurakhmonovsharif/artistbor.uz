  ...
  return (
    <span
      className={cn(
        ...
        good && "border-emerald-400/30 bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10",
        danger && "border-rose-400/30 bg-rose-50 text-rose-600 dark:bg-rose-500/10",
